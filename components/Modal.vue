...
<div class="modal-overlay  bg-gradient-to-t from-[#000000] bg-opacity-90 backdrop-filter backdrop-blur-sm drop-shadow-2xl" v-if="modalActive">
  <div class="modal">
...
export default {
  props: {
    modalActive: Boolean,
    content: {
    type: [Object, null],  // Acepta objetos de componente o nulo
    default: null,
  }, // Componente específico que se mostrará
    modalKey: String, // Identificador único para el modal
  },
  methods: {
    close() {
      this.$emit('close');
